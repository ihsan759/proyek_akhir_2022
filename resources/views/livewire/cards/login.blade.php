<section
    class="bg-gradient-to-r from-[#3069e4] via-purple-500 to-[#2988e0] min-h-screen pt-12 md:pt-20 pb-6 px-2 md:px-0"
            ...
            <form class="flex flex-col" wire:submit.prevent="login">
                <div class="mb-6 pt-3 rounded bg-gray-200">
                    ...
                    <input type="text" id="email"
                        ...
                        wire:model="email" autofocus autocomplete="off" />
                </div>
                @error('email')
                ...
                @enderror
                <button
                    class="bg-[#3069e4] hover:bg-[#1a449e] text-white font-bold py-3 rounded shadow-lg hover:shadow-xl transition duration-200"
                    type="submit">
                    <span wire:loading wire:target="login" class="text-center mx-auto">
                        <img src="{{ asset('assets/loading.svg') }}" class="animate-spin h-6 w-6 mx-auto"
                            alt="">
                    </span>
                    <span wire:loading.remove wire:target="login">Sign In</span></button>
            </form>
        </section>
    </div>
</section>
