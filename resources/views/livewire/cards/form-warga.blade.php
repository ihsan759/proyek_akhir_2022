<div class="lg:flex items-start mt-10 gap-7">
    <div class="bg-white mx-auto rounded-lg shadow-lg w-full mb-7">
        <form action="{{ route('warga.ktp.store') }}" method="post" class="py-5">
            ...
            <div class="px-3 mt-5">
                <button type="submit"
                    class="bg-blue-500 hover:bg-blue-800 text-white px-3 py-2 rounded-lg w-full">Submit</button>
            </div>
        </form>
    </div>
        ...
        <form action="{{ route('warga.kk.store') }}" method="post" class="py-5">
            ...
            <div class="mt-3 px-3">
                ...
                <textarea id="message" rows="4"
                    ...
                    name="alamat" placeholder="Write your thoughts here...">{{ old('alamat') }}</textarea>
                @error('alamat')
